...
Run on SPARK (needs postgres):
    ...
    python summary_hybrid/plot_mrr_overview.py
    python summary_hybrid/plot_mrr_overview.py --sweep-id <uuid> --out plots_png/summary_hybrid_mrr.png
"""
...
def main() -> None:
    ...
    p.add_argument("--out", type=Path,
                   default=Path(__file__).resolve().parent.parent / "plots_png" / "summary_hybrid_mrr.png",
                   help="Output PNG path (default: ../plots_png/summary_hybrid_mrr.png)")
    args = p.parse_args()
