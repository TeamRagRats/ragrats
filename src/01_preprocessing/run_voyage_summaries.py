...
import step_04_summaries.voyage.voyage_summaries as step2
...
def main() -> None:
    ...
    parser.add_argument("--voyage-key", type=str, default=None, metavar="KEY",
                        help="Run only for one specific voyage (skips get_pending_voyages)")
    parser.add_argument("--limit", type=int, default=None, metavar="N",
                        help="Process only the first N voyages (for testing, ignored if --voyage-key is set)")
