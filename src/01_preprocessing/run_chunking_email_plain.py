...
# Entry point for plain chunking of emails (step_05_chunking/email_plain).
...
#
# Run: python -m src.01_preprocessing.run_chunking_email_plain [--limit N] [--verbose]
...
from step_05_chunking.email_plain import pipeline
