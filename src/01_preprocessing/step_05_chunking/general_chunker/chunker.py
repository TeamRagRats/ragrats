...
# Pure, source-agnostic chunking logic. No DB access — imported by the
# attachment and email chunkers, which feed it their respective source text
# (attachments: structured_md, emails: body_cleaned).
#
