...
# Per-attachment orchestrator for plain chunking:
#   For each chunk: embed(chunk.text) → one vector per chunk.
#   No email_summary prefix, no full-doc forward pass — baseline control for
#   comparing against 'late' and 'context' strategies.
...
from step_06_embedding.attachment_plain.db import (
    get_pending_sha256s,
    get_attachment_data,
    upsert_chunks,
)
